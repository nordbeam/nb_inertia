...
type SetDataAction<TForm> = SetDataByObject<TForm> & SetDataByMethod<TForm> & SetDataByKeyValuePair<TForm>;
 ...
 */
export declare function useHttp<TForm extends FormDataType<TForm>, TResponse = unknown>(): UseHttp<TForm, TResponse>;
/**
 * Create standard request with inline or lazy initial data.
 */
export declare function useHttp<TForm extends FormDataType<TForm>, TResponse = unknown>(data: FormDataArgument<TForm>): UseHttp<TForm, TResponse>;
/**
 * Create standard request with remember key support.
 */
export declare function useHttp<TForm extends FormDataType<TForm>, TResponse = unknown>(rememberKey: string, data: FormDataArgument<TForm>): UseHttp<TForm, TResponse>;
/**
 * Create a precognitive request from explicit method, URL, and data.
 */
export declare function useHttp<TForm extends FormDataType<TForm>, TResponse = unknown>(method: Method | (() => Method), url: string | (() => string), data: FormDataArgument<TForm>): UseHttpPrecognitiveProps<TForm, TResponse>;
/**
 * Create a precognitive request from a route result or lazy route resolver.
 */
export declare function useHttp<TForm extends FormDataType<TForm>, TResponse = unknown>(route: UrlMethodPair | RouteResolver, data: FormDataArgument<TForm>): UseHttpPrecognitiveProps<TForm, TResponse>;
/**
 * Convenience overload that preserves nb_inertia's historic data-first route binding API.
 */
export declare function useHttp<TForm extends FormDataType<TForm>, TResponse = unknown>(data: FormDataArgument<TForm>, route: RouteLike): UseHttpPrecognitiveProps<TForm, TResponse>;
/**
