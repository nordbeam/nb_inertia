import { FlashData } from './useFlash';
/**
 ...
 */
export declare function useOnFlash<T extends FlashData = FlashData>(callback: OnFlashCallback<T>): void;
export default useOnFlash;
//# sourceMappingURL=useOnFlash.d.ts.map