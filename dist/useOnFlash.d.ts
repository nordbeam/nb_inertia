 ...
 */
export declare interface FlashEventDetail<T = FlashData> {
    flash: T;
}
 ...
 */
export declare type OnFlashCallback<T = FlashData> = (flash: T) => void;
 ...
 */
declare function useOnFlash<T extends FlashData = FlashData>(callback: OnFlashCallback<T>): void;
