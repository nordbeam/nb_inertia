 ...
 */
declare type RemoveFirstParam<T extends any[]> = T extends [any, ...infer Rest] ? Rest : T;

/**
 * Route helper function with method variants (no form support)
 * Matches the interface generated by nb_routes in rich mode
 */
export declare interface RouteHelper<TParams extends any[] = any[]> {
 ...
 * Matches the interface generated by nb_routes in rich mode
 */
export declare interface RouteHelperWithForm<TParams extends any[] = any[]> {
    /** Main helper - returns RouteResult with url and method */
    (...args: TParams): RouteResult;
    /** GET method variant */
    get(...args: TParams): RouteResult;
 ...
 */
declare type ScopedRouteHelper<T> = T extends RouteHelperWithForm<infer TParams> ? RouteHelperWithForm<RemoveFirstParam<TParams>> : T extends RouteHelper<infer TParams> ? RouteHelper<RemoveFirstParam<TParams>> : T;

/**
 * Transform all route helpers in an object to their scoped versions
 */
export declare type ScopedRoutes<TRoutes extends Record<string, any>> = {
