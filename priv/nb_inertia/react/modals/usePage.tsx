...
export function usePage<TProps extends PageProps = PageProps>(): Page<TProps> {
  ...
  if (modalPage) {
    ...
    return {
      ...
      deferredProps: modalPage.deferredProps,
      initialDeferredProps: modalPage.initialDeferredProps,
      rescuedProps: modalPage.rescuedProps ?? [],
      mergeProps: modalPage.mergeProps,
      prependProps: modalPage.prependProps,
      deepMergeProps: modalPage.deepMergeProps,
      matchPropsOn: modalPage.matchPropsOn,
      sharedProps: modalPage.sharedProps,
      scrollProps: modalPage.scrollProps,
      onceProps: modalPage.onceProps,
      optimisticUpdatedAt: modalPage.optimisticUpdatedAt,
    } as Page<TProps>;
  }
