/**
 * Full Vue schema-runtime entrypoint.
 *
 * Import `vue/createInertiaApp` when only the adapter is needed: that entry
...
export type { VueCreateInertiaAppOptions } from './createInertiaApp';
